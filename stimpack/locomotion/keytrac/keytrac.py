...
class KeyTrac(QMainWindow):
    ...
    def initUI(self):
        ...
        # Next to this file, wherever this file is: the app is also launched as a plain script by
        # path (KeytracManager), so it cannot count on being imported from its package.
        pixmap = QPixmap(os.path.join(os.path.dirname(os.path.abspath(__file__)), "keytrac_map.png"))
