...
**stimpack 44 commits**, **labpack-template 10**, **clandinin_labpack 1**. Verified by
`ruff` + a **169-test suite** (unit / integration / gui / gl / e2e), which now also runs
...
- **Test suite + CI** (#19, #35): 169 tests across five tiers — including
